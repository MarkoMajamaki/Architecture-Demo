import 'package:producer/core/constants.dart';
import 'package:flutkit/flutkit.dart';
import 'package:flutter/material.dart';
import 'package:producer/core/routes.dart';
import 'package:producer/core/theme.dart';
import 'package:producer/services/maintab_navigation_service.dart';
import 'package:producer/services/servicelocator.dart';
import 'package:producer/views/customers_view.dart';
import 'package:producer/views/orders_view.dart';
import 'package:producer/widgets/bottom_menu_widget.dart';
import 'package:producer/widgets/side_menu_widget.dart';
...
class _MainViewState extends State<MainView> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: (isMobileClient(context)) ? _producerShell() : _desktopShell(),
    );
  }

  ///
  /// Create main view producer content with bottom tab navigation
  ///
  Widget _producerShell() {
    return Scaffold(
      body: _content(),
